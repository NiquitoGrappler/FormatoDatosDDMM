...
Profile: Biomedica_S_HR
Parent: Observation
Id: BiomedicaSHR
Title: "Perfil de frecuencia cardíaca de multiples valores de medición"
Description: "Para promover la interoperabilidad y la adopción a través de una implementación común, este perfil establece las expectativas mínimas para que el recurso Observación registre, busque y obtenga observaciones de frecuencia cardíaca con un código LOINC estándar. Se basa en el Perfil de Signos Vitales Básicos de EE.UU. e identifica los elementos básicos *adicionales* obligatorios, las extensiones, los vocabularios y los conjuntos de valores que **deben** estar presentes en el recurso Observación cuando se utiliza este perfil. Proporciona la base para el desarrollo de normas para casos de uso específicos."
* ^url = "http://DisenodatosDDMM.uv.cl/StructureDefinition/BiomedicaSHR"
* ^version = "0.1.0"
* ^experimental = false
* ^date = "2022-04-20"
...
* valueSampledData ^short = "Datos de frecuencia cardiaca"
