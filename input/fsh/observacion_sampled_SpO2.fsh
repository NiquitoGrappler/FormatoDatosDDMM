...
Profile: Biomedica_S_SpO2
Parent: Observation
Id: BiomedicaSSpO2
Title: "Perfil de Saturación de oxigeno de multiples valores de medición"
Description: "Para promover la interoperabilidad y la adopción a través de una implementación común, este perfil establece las expectativas mínimas para que el recurso Observación registre, busque y obtenga observaciones de saturación de oxigeno con un código LOINC estándar. Se basa en el Perfil de Signos Vitales Básicos de EE.UU. e identifica los elementos básicos *adicionales* obligatorios, las extensiones, los vocabularios y los conjuntos de valores que **deben** estar presentes en el recurso Observación cuando se utiliza este perfil. Proporciona la base para el desarrollo de normas para casos de uso específicos."
* ^url = "http://DisenodatosDDMM.uv.cl/StructureDefinition/BiomedicaSSpO2"
* ^experimental = false
* ^date = "2022-04-20"
...
* valueSampledData ^short = "Datos de Saturación de oxigeno"
