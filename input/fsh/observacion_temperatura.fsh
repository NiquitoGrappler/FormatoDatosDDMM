...
Description: "Para promover la interoperabilidad y la adopción a través de una implementación común, este perfil establece las expectativas mínimas para que el recurso Observación registre, busque y obtenga observaciones de temperatura con un código LOINC estándar y unidades de medida UCUM. Se basa en el Perfil de Signos Vitales Básicos de EE.UU. e identifica los elementos básicos *adicionales* obligatorios, las extensiones, los vocabularios y los conjuntos de valores que **deben** estar presentes en el recurso Observación cuando se utiliza este perfil. Proporciona la base para el desarrollo de normas para casos de uso específicos."
* ^url = "http://DisenodatosDDMM.uv.cl/StructureDefinition/BiomedicaT"
* ^experimental = false
* ^date = "2022-04-20"
* ^contact.name = "Nicolas Mendoza"
* ^contact.telecom.system = #url
* ^contact.telecom.value = "http://DisenodatosDDMM.uv.cl/infosalud.uv"
* . ^short = "Perfil temperatura de la escuela de ingenieria biomedica uv"
* . ^definition = "\\-"
* . ^comment = "\\-"
...
* code ^definition = "Corresponde al perfil de temperatura, el cual se encuentra asociado a un sistema terminologico con la sintaxis definida por el sistema y el su codigo especifico"
* device 1.. MS
...
* valueQuantity ^definition = "Corresponde a un valor de estado final de una observación de temperatura"
* valueQuantity.value 1..1 MS
* valueQuantity.value only decimal
* valueQuantity.value ^short = "Valor numérico"
* valueQuantity.value ^definition = "Corresponde al valor asignado a la medición de temperatura"
* valueQuantity.unit 1..1 MS
* valueQuantity.unit only string
* valueQuantity.unit ^short = "La representación de la unidad"
* valueQuantity.unit ^definition = "Representación de la unidad de medición que le corresponde a la temperatura"
